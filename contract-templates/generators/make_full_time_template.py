...
# Title
add_para('僱傭合約', size=20, bold=True, align=WD_ALIGN_PARAGRAPH.CENTER, space_after=8)

# Parties
add_para('甲方（受僱人）：＿＿＿＿＿＿＿＿＿')
add_para('乙方（僱傭人）：益循生活股份有限公司', space_after=4)
add_para('茲為乙方僱用甲方為乙方勞工，訂立本合約如下，以茲共同遵守：', space_after=4)

# 第一條
add_clause_head('第一條')
add_para('甲方到職日：中華民國＿＿年＿＿月＿＿日到職。', indent_cm=0.5, space_after=3)

# 第二條
add_clause_head('第二條')
add_para('1. 職稱：＿＿＿＿＿＿＿＿＿', indent_cm=0.5)
add_para('2. 工時：每月合計至少＿＿小時。', indent_cm=0.5)
add_para('3. 工資：試用期薪資總額（含稅）新台幣＿＿＿＿＿元整（包含＿＿＿＿＿績效獎金），試用期於店長＿＿＿＿＿確認通過後於＿＿年＿＿月＿＿日起調整為新台幣＿＿＿＿＿元整（包含＿＿＿＿＿績效獎金）。', indent_cm=0.5)
add_para('4. 績效獎金之考核項目由店長＿＿＿＿＿考核，表列如下：', indent_cm=0.5)
for s in [
    '1. 出勤狀況；',
    '2. 每個餐期協助出餐工作、清消工作之表現；',
    '3. 有無遵守標準作業流程處理並通報主管客訴事件；',
    '4. 工作態度；',
    '5. 其他優良表現，值得獎勵。',
]:
    add_para(s, indent_cm=1.2)
add_para('5. 工資發給日：按月發給，發給日為每月 10 號，遇假日順延。', indent_cm=0.5)
add_para('6. 甲方任用後，若其能力適性與業績不能符合乙方組織功能運作需求，或發生重大事故，或其考核未達標準，或經營環境變遷，乙方得解除甲方之職務任命，降級或異動。', indent_cm=0.5, space_after=3)
...
add_para('1. 非有下列情形之一者，乙方不得預告甲方終止本合約：①歇業或轉讓時。②虧損或業務緊縮時。③不可抗力暫停工作在一個月以上時。④業務性質變更，有減少勞工必要，又無適當工作可供安置時。⑤乙方對於所擔任之工作確不能勝任時。', indent_cm=0.5)
add_para('2. 乙方依前項規定終止本合約者，其預告期間應依下列規定辦理：①在乙方繼續工作三個月以上一年未滿者，於十日前預告之。②在乙方繼續工作一年以上未滿三年者，於廿日前預告之。③在乙方繼續工作三年以上者，於三十日前預告之。', indent_cm=0.5)
add_para('3. 甲方有下列情形之一者，乙方得不經預告終止契約：①於訂立本合約時為虛偽意思表示，使乙方誤信而有受損害之虞者。②對於乙方、乙方家屬、乙方代理人或其他共同工作之勞工及客戶，實施暴行或有重大侮辱之行為者。③受有期徒刑以上刑之宣告確定，而未諭知緩刑或未准易科罰金者。④違反本合約或工作規則，情節重大者。⑤故意損耗機器、工具、原料、產品，或其他乙方所有物品，或故意洩漏乙方技術上、營業上之秘密，致乙方受有損害者。⑥無正當理由繼續曠職三日，或一個月內曠職達六日者。⑦甲方無故洩漏乙方或乙方客戶之工商秘密等應保密事項者。', indent_cm=0.5)
add_para('4. 其餘未盡事宜，悉依乙方工作規則、《勞動基準法》及其他相關法令之規定辦理。', indent_cm=0.5)
add_para('5. 甲方應於本合約終止日前製作交接清單且備齊相關資訊檔案，完成交接予乙方指定之第三人。', indent_cm=0.5, space_after=3)
...
add_para('1. 本協議未盡事宜，經甲、乙雙方同意，得以書面另訂補充協議。', indent_cm=0.5)
add_para('2. 本協議一式兩份，雙方各執一份為憑，並自甲、乙雙方簽署後生效。', indent_cm=0.5, space_after=6)

# 簽署頁
add_para('（簽署頁）', bold=True, align=WD_ALIGN_PARAGRAPH.CENTER, space_after=4)

add_para('受僱人（甲方）', bold=True)
...
out = '/Users/chiu/.claude/skills/contract-templates/templates/yixun-sheng-huo/full-time-contract.docx'
doc.save(out)
print(f'Saved: {out}')
import shutil
work_out = '/Users/chiu/work/yixun-sheng-huo/documents/全職僱傭合約_範本_益循生活.docx'
